-- Migration generated by dbdev add at: 2026-09-26 16:28:32
-- Extension: pgledger
-- Default version: 0.0.1
-- Comment: Double-entry ledger for Postgres, inspired by TigerBeetle
-------------------------------------- Initial installation of version: 0.0.1
select pgtle.install_extension('pgledger', '0.0.1', $comment_1uMKxcV6X5vFmTcB$Double-entry ledger for Postgres, inspired by TigerBeetle$comment_1uMKxcV6X5vFmTcB$, $sql_1uMKxcV6X5vFmTcB$-- Makes a table append-only. Statement-level so it also covers TRUNCATE.
...
$sql_1uMKxcV6X5vFmTcB$, array[]::text[] );
