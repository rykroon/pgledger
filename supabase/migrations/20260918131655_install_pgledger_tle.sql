-- Migration generated by dbdev add at: 2026-09-26 01:25:01
-- Extension: pgledger
-- Default version: 0.0.1
-- Comment: Double-entry ledger for Postgres, inspired by TigerBeetle
-------------------------------------- Initial installation of version: 0.0.1
select pgtle.install_extension('pgledger', '0.0.1', $comment_tzEeFQb1fFKtIwJt$Double-entry ledger for Postgres, inspired by TigerBeetle$comment_tzEeFQb1fFKtIwJt$, $sql_tzEeFQb1fFKtIwJt$-- Makes a table append-only. Statement-level so it also covers TRUNCATE.
...
$sql_tzEeFQb1fFKtIwJt$, array[]::text[] );
