-- Migration generated by dbdev add at: 2026-09-26 02:05:44
-- Extension: pgledger
-- Default version: 0.0.1
-- Comment: Double-entry ledger for Postgres, inspired by TigerBeetle
-------------------------------------- Initial installation of version: 0.0.1
select pgtle.install_extension('pgledger', '0.0.1', $comment_CRdc4urKZlIw1RdN$Double-entry ledger for Postgres, inspired by TigerBeetle$comment_CRdc4urKZlIw1RdN$, $sql_CRdc4urKZlIw1RdN$-- Makes a table append-only. Statement-level so it also covers TRUNCATE.
...
$sql_CRdc4urKZlIw1RdN$, array[]::text[] );
