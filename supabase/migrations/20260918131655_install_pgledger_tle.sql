-- Migration generated by dbdev add at: 2026-09-18 13:17:08
-- Extension: pgledger
-- Default version: 0.0.1
-- Comment: Double-entry ledger for Postgres, inspired by TigerBeetle
-------------------------------------- Initial installation of version: 0.0.1
select pgtle.install_extension('pgledger', '0.0.1', $comment_VfOwrMR4kIf9BhxU$Double-entry ledger for Postgres, inspired by TigerBeetle$comment_VfOwrMR4kIf9BhxU$, $sql_VfOwrMR4kIf9BhxU$-- Makes a table append-only. Statement-level so it also covers TRUNCATE.
...
$sql_VfOwrMR4kIf9BhxU$, array[]::text[] );
