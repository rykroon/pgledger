-- Migration generated by dbdev add at: 2026-09-22 16:30:31
-- Extension: pgledger
-- Default version: 0.0.1
-- Comment: Double-entry ledger for Postgres, inspired by TigerBeetle
-------------------------------------- Initial installation of version: 0.0.1
select pgtle.install_extension('pgledger', '0.0.1', $comment_SXl14CF50mK46MZz$Double-entry ledger for Postgres, inspired by TigerBeetle$comment_SXl14CF50mK46MZz$, $sql_SXl14CF50mK46MZz$-- Makes a table append-only. Statement-level so it also covers TRUNCATE.
...
$sql_SXl14CF50mK46MZz$, array[]::text[] );
