-- Migration generated by dbdev add at: 2026-09-23 13:13:01
-- Extension: pgledger
-- Default version: 0.0.1
-- Comment: Double-entry ledger for Postgres, inspired by TigerBeetle
-------------------------------------- Initial installation of version: 0.0.1
select pgtle.install_extension('pgledger', '0.0.1', $comment_KNiDbTJqFpphiImU$Double-entry ledger for Postgres, inspired by TigerBeetle$comment_KNiDbTJqFpphiImU$, $sql_KNiDbTJqFpphiImU$-- Makes a table append-only. Statement-level so it also covers TRUNCATE.
...
$sql_KNiDbTJqFpphiImU$, array[]::text[] );
