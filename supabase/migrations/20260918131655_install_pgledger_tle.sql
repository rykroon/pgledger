-- Migration generated by dbdev add at: 2026-09-24 12:47:30
-- Extension: pgledger
-- Default version: 0.0.1
-- Comment: Double-entry ledger for Postgres, inspired by TigerBeetle
-------------------------------------- Initial installation of version: 0.0.1
select pgtle.install_extension('pgledger', '0.0.1', $comment_GeHPq5zcDyhzcrKl$Double-entry ledger for Postgres, inspired by TigerBeetle$comment_GeHPq5zcDyhzcrKl$, $sql_GeHPq5zcDyhzcrKl$-- Makes a table append-only. Statement-level so it also covers TRUNCATE.
...
$sql_GeHPq5zcDyhzcrKl$, array[]::text[] );
